OC.L10N.register(
    ...
    "Save changes" : "変更を保存",
    "This app is supported via your current Nextcloud subscription." : "このアプリは、現行のCDE360サブスクリプションでサポートされています。",
    "Supported" : "サポート",
    ...
    "No results" : "該当なし",
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "このアプリは CDE360 の最小バージョンが指定されていません．将来、エラーが発生する可能性があります.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "このアプリは CDE360 バージョンの上限が指定されていません．将来、エラーが発生する可能性があります.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "このアプリはあなたのCDE360のバージョンと互換性があるとしてマークされていません。 続行しても、アプリをインストールすることはできます。 アプリが期待通りに動作しない可能性があることに注意してください。",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "CDE360 iOSアプリ",
    "Nextcloud Android app" : "CDE360 Android アプリ",
    "Nextcloud Talk for iOS" : "iOS用CDE360 Talk",
    "Nextcloud Talk for Android" : "Android用CDE360 Talk",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the Nextcloud data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "デバイスを紛失した場合や、組織外に出た場合、{userid}に関連付けられたすべてのデバイスからリモートで CDE360 のデータを消去することができます。デバイスがインターネットに接続されている場合にのみ機能します。",
    ...
    "It's important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "サーバーのセキュリティとパフォーマンスにとって重要なことは、すべてが正確に設定されていることです。あなたの助けとなるよう、CDE360では一部の自動チェックを行っています。詳細な情報は、リンク先のドキュメントを参照してください。",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "CDE360のセキュリティは、<a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">セキュリティスキャン ↗</a>でチェックしてください。",
    "Version" : "バージョン",
    ...
    "Encryption alone does not guarantee security of the system. Please see documentation for more information about how the encryption app works, and the supported use cases." : "暗号化だけで、システムのセキュリティが保証されるわけではありません。暗号化アプリがどのように動作するかの詳細な情報や、サポートされているユースケースについては、CDE360 のドキュメントを参照してください。",
    ...
    "Personal" : "個人",
    "Administration" : "管理",
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "{communityopen} CDE360コミュニティ{linkclose}によって開発された{githubopen}ソースコード{linkclose}は、{licenseopen} AGPL {linkclose}でライセンスされています。",
    ...
    "Zulu" : "Zulu",
    "Official apps are developed by and within the community. They offer central functionality and are ready for production use." : "公式アプリは Nextcloud コミュニティにより開発されています。公式アプリは CDE360 の中心的な機能を提供し、製品として可能です。",
    "Official" : "公式",
