OC.L10N.register(
    ...
    "Unlimited" : "무제한",
    "Verifying" : "검사",
    "Nextcloud settings" : "CDE360 환경설정",
    ...
    "All" : "모두",
    "No results" : "결과 없음",
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "이 앱은 CDE360 최소 버전을 지정하지 않았습니다. 차후 버전에서는 오류로 처리됩니다.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "이 앱은 CDE360 최대 버전을 지정하지 않았습니다. 차후 버전에서는 오류로 처리됩니다.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "이 앱은 현재 CDE360 버젼과 호환되지 않습니다.  이 앱을 설치하면, 제대로 작동하지 않을 수 있습니다.",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "<a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">우리의 보안 검사 ↗</a>에서 당신의 CDE360의 보안을 점검하세요.",
    "Version" : "버전",
    ...
    "Personal" : "개인",
    "Administration" : "관리",
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "{communityopen}CDE360 커뮤니티{linkclose}에서 개발, {githubopen}소스 코드{linkclose}는 {licenseopen}<abbr title=\"Affero General Public License\">AGPL</abbr>{linkclose} 라이선스를 따릅니다.",
    ...
    "Korean" : "한국어",
    "Official apps are developed by and within the community. They offer central functionality and are ready for production use." : "커뮤니티가 개발한 공식 앱입니다. 이 앱은 CDE360의 핵심 기능이며 프로덕션 환경에서 사용할 수 있습니다.",
    "Official" : "공식",
