OC.L10N.register(
    ...
    "Edit guest name" : "Изменить имя гостя",
    "Save guest name" : "Сохранить имя гостя",
    ...
    "Verifying" : "Проверка",
    "Nextcloud settings" : "Параметры CDE360",
    ...
    "This app is supported via your current Nextcloud subscription." : "Это приложение поддерживается через вашу текущую подписку CDE360.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Для этого приложения не указана минимальная поддерживаемая версия CDE360,  в будущем это будет считаться ошибкой.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Для этого приложения не указана максимальная поддерживаемая версия CDE360, в будущем это будет считаться ошибкой.",
    ...
    "No apps found for your version" : "Приложений, совместимых с установленной версией CDE360, не найдено",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Это приложение не отмечено как совместимое с вашей версией CDE360. Если вы продолжите, вы сможете установить это приложение, однако оно может работать не так, как ожидается.",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad iOS",
    "Nextcloud iOS app" : "Приложение CDE360 для iOS",
    "Nextcloud Android app" : "Приложение CDE360 для Android",
    "Nextcloud Talk for iOS" : "CDE360 Talk для iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk для Android",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the Nextcloud data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Это действие позволяет удалить все данные CDE360 с устройств {userid}, например, в случае утери или при завершении работы сотрудника в компании. Удаление будет выполнено только если устройства подключены к интернету.",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Проверить безопасность CDE360 <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">нашим сканером ↗</a>.",
    "Version" : "Версия",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Разработано {communityopen}сообществом CDE360{linkclose}, {githubopen}исходный код{linkclose} лицензируется в соответствии с {licenseopen}AGPL{linkclose}.",
