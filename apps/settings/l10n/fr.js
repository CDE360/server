OC.L10N.register(
    ...
    "Unlimited" : "Illimité",
    "Verifying" : "Vérification en cours",
    "Nextcloud settings" : "Paramètres CDE360",
    ...
    "This app is supported via your current Nextcloud subscription." : "Vous supportez cette application grâce à votre abonnement CDE360.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Cette application n'a pas de version minimum CDE360 exigée. Ce sera considéré comme une erreur à l'avenir.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Cette application n'a pas de version maximum CDE360 exigée. Ce sera considéré comme une erreur à l'avenir.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Cette application n'est pas indiquée comme étant compatible avec votre version de CDE360. Si vous continuez vous pourrez toujours installer l'app. Notez cependant qu'elle pourrait ne pas fonctionner comme prévu.",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "Application iOS CDE360",
    "Nextcloud Android app" : "Application Android CDE360",
    "Nextcloud Talk for iOS" : "CDE360 Talk pour iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk pour Android",
    ...
    "It's important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "Il est important pour la sécurité et la performance de votre instance que celle-ci soit correctement configurée. Afin de vous aider, votre instance CDE360 effectue des vérifications automatiques. Pour de plus amples informations, veuillez consulter la documentation liée.",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Vérifier la sécurité de votre CDE360 grâce à <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">notre scan de sécurité ↗</a>",
    "Version" : "Version",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Développé par la {communityopen}communauté CDE360{linkclose}, le {githubopen}code source{linkclose} est sous licence {licenseopen}AGPL{linkclose}.",
