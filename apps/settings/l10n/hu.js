OC.L10N.register(
    ...
    "Unlimited" : "Korlátlan",
    "Verifying" : "Ellenőrzés",
    "Nextcloud settings" : "CDE360 beállítások",
    ...
    "This app is supported via your current Nextcloud subscription." : "Az alkalmazás támogatását a jelenlegi CDE360 előfizetése biztosítja.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Ennek az alkalmazásnak nincs minimum szükséges CDE360 verziója megadva. Ez hiba lesz a jövőben.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Ennek az alkalmazásnak nincs maximum szükséges CDE360 verziója megadva. Ez hiba lesz a jövőben.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ez az alkalmazás nincs megjelölve, hogy kompatibilis lenne a jelenlegi CDE360 verzióval. Ha folytatja telepítheti az alkalmazást. Azonban az alkalmazás lehet, hogy nem fog rendeltetés szerint működni.",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "CDE360 iOS alkalmazás",
    "Nextcloud Android app" : "CDE360 Android alkalmazás",
    "Nextcloud Talk for iOS" : "CDE360 Beszélgetés iOS-re",
    "Nextcloud Talk for Android" : "CDE360 Beszélgetés Android-ra",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the Nextcloud data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Eszköz elvesztés vagy vállalatból való kilépés esetén ez távolról képes eltávolítani a CDE360 adatokat minden hozzá kapcsolódott eszközről: {userid}",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Ellenőrizze a CDE360 biztonságát <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\"> a biztonsági ellenőrzőnkkel ↗</a>.",
    "Version" : "Verzió",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Fejleszti a {communityopen}CDE360 közösség{linkclose}, a {githubopen}forráskódra{linkclose} az {licenseopen}AGPL{linkclose} licenc vonatkozik.",
