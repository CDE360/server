OC.L10N.register(
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "此應用程式並未配置最低的CDE360版本，未來將會產生問題。",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "此應用程式並未配置最高的CDE360版本，未來將會產生問題。",
    ...
    "Personal" : "個人",
    "Administration" : "管理",
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "由 {communityopen}CDE360 社群{linkclose}開發，{githubopen}原始碼{linkclose}以 {licenseopen}AGPL 授權{linkclose}釋出",
