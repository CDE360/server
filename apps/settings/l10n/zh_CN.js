OC.L10N.register(
    ...
    "Save changes" : "保存修改",
    "This app is supported via your current Nextcloud subscription." : "根据您的CDE360订阅，此应用受到支持。",
    "Supported" : "受支持",
    ...
    "No results" : "没有结果",
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "该应用没有指定支持的 CDE360 最低版本。可能会在将来出现问题。",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "该应用没有指定支持的 CDE360 最高版本。可能会在将来出现问题。",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "此应用被标记为与您的 CDE360 版本不兼容。如果您要继续，您仍可安装此应用。请注意此应用可能不会正常工作。",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "CDE360 iOS 应用",
    "Nextcloud Android app" : "CDE360 Android 应用",
    "Nextcloud Talk for iOS" : "CDE360 Talk for iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk for Android",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the Nextcloud data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "如果设备丢失或退出组织，这可以从与 {userid} 关联的所有设备中远程擦除 CDE360 数据。 仅当设备连接到互联网时才有效。",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "通过<a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">我们的安全检查 ↗</a>检查您 CDE360 的安全",
    "Version" : "版本",
    ...
    "Personal" : "个人",
    "Administration" : "管理",
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "由 {communityopen}CDE360 community{linkclose} 开发，{githubopen}源代码{linkclose} 基于 {licenseopen}AGPL{linkclose} 许可协议。",
