OC.L10N.register(
    ...
    "Nextcloud settings" : "CDE360 instellingen",
    ...
    "This app is supported via your current Nextcloud subscription." : "Deze app wordt ondersteund via je huidige CDE360 abonnement.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Deze app heeft geen minimum CDE360 versie toegewezen gekregen. In de toekomst wordt dit wordt een fout.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Deze app heeft geen maximum CDE360 versie toegewezen gekregen. In de toekomst wordt dit wordt een fout.",
    ...
    "Nextcloud Talk for iOS" : "CDE360 Talk voor iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk voor Android",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the Nextcloud data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "In het geval van een verloren apparaat of het verlaten van de organisatie, kan dit op afstand de CDE360-gegevens wissen van alle apparaten die zijn gekoppeld aan {userid}. Werkt alleen als de apparaten zijn verbonden met het internet.",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Controleer de beveiliging van je CDE360 via <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">onze securityscan ↗</a>.",
    "Version" : "Versie",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Ontwikkeld door de {communityopen}CDE360 community{linkclose}, de {githubopen}broncode{linkclose} is gelicenseerd onder de {licenseopen}AGPL{linkclose}.",
