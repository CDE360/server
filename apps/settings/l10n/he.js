OC.L10N.register(
    ...
    "Unlimited" : "ללא הגבלה",
    "Verifying" : "מתבצע אימות",
    "Nextcloud settings" : "הגדרות CDE360",
    ...
    "This app is supported via your current Nextcloud subscription." : "יישומון זה נתמך על ידי מינוי ה־CDE360 הנוכחי שלך.",
    "Supported" : "נתמך",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "ליישומון זה לא מוקצית גרסת CDE360 מזערית. מצב כזה עשוי להוביל לשגיאה בעתיד.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "ליישומון זה לא מוקצית גרסת CDE360 מרבית. מצב כזה עשוי להוביל לשגיאה בעתיד.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "היישומון הזה לא מסומן כנתמך בגרסת ה־CDE360. עדיין יתאפשר לך להמשיך ולהתקין את היישומון. נא לשים לב שיכול להיות שהיישומון לא יעבוד כצפוי.",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "יישומון iOS של CDE360",
    "Nextcloud Android app" : "יישומון Android של CDE360",
    "Nextcloud Talk for iOS" : "CDE360 Talk ל־iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk ל־Android",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "בדיקת האבטחה של ה־CDE360 שלך באמצעות <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">סריקת האבטחה שלנו ↖️</a>.",
    "Version" : "גרסה",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "בפיתוח על ידי {communityopen}קהילת CDE360{linkclose}, {githubopen}קוד המקור{linkclose} זמין ברישיון {licenseopen}AGPL{linkclose}.",
