OC.L10N.register(
    ...
    "Unlimited" : "Ilimitado",
    "Verifying" : "Verificando",
    "Nextcloud settings" : "Configurações CDE360",
    ...
    "This app is supported via your current Nextcloud subscription." : "Este aplicativo é suportado pela sua assinatura atual do CDE360.",
    "Supported" : "Suportado",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Este aplicativo não possui uma versão mínima atribuída para uso no CDE360. Isto poderá se converter em um erro no futuro.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Este aplicativo não possui uma versão máxima atribuida para uso no CDE360. Isto poderá se converter em um erro no futuro.",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "Aplicativo iOS CDE360",
    "Nextcloud Android app" : "Aplicativo Android CDE360",
    "Nextcloud Talk for iOS" : "CDE360 Talk para iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk para Android",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the Nextcloud data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Em caso de perda do dispositivo ou saída da organização, pode-se limpar remotamente os dados do CDE360 dos dispositivos associados ao {userid}. Só funciona se estiverem conectados à Internet.",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Verifique a segurança do seu CDE360 em <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">nossa verificação de segurança ↗</a>.",
    "Version" : "Versão",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Desenvolvido pela {communityopen}comunidade CDE360{linkclose}. O {githubopen}código-fonte{linkclose} é licenciado sob a {licenseopen}AGPL{linkclose}.",
