OC.L10N.register(
    ...
    "Verifying" : "Verifiera",
    "Nextcloud settings" : "CDE360-inställningar",
    ...
    "This app is supported via your current Nextcloud subscription." : "Den här appen stöds via ditt nuvarande CDE360-abonnemang.",
    "Supported" : "Stöds",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Denna app har ingen lägsta CDE360-version tilldelad. Detta kommer att innebära ett problem i framtiden.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Denna app har ingen minimum CDE360-version tilldelad. Detta kommer att innebära ett problem i framtiden.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Den här appen är inte markerad som kompatibel med din CDE360-version. Om du fortsätter kan du fortfarande installera appen. Observera att appen kanske inte fungerar som förväntat.",
    ...
    "Nextcloud Talk for iOS" : "CDE360 Talk för iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk för Android",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Kontrollera säkerheten för ditt CDE360 över <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">vår säkerhetsgenomsökning ↗</a>.",
    "Version" : "Version",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Utvecklat av {communityopen}CDE360-gemenskapen{linkclose}, {githubopen}källkoden{linkclose}  är licensierad enligt {licenseopen}AGPL-standard{linkclose}.",
