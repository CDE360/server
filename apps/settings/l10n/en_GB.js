OC.L10N.register(
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "This app has no minimum CDE360 version assigned. This will cause an error in the future.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "This app has no maximum CDE360 version assigned. This will cause an error in the future.",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Developed by the {communityopen}CDE360 community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}.",
