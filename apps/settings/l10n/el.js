OC.L10N.register(
    ...
    "Verifying" : "Γίνεται επαλήθευση",
    "Nextcloud settings" : "Ρυθμίσεις CDE360 ",
    ...
    "This app is supported via your current Nextcloud subscription." : "Αυτή η εφαρμογή υποστηρίζεται μέσω της τρέχουσας συνδρομής σας στο CDE360.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Αυτή η εφαρμογή δεν έχει ελάχιστη έκδοση του CDE360 ανατεθειμένη. Αυτό θα αποτελεί σφάλμα στο μέλλον.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Αυτή η εφαρμογή δεν έχει μέγιστη έκδοση του CDE360 ανατεθειμένη. Αυτό θα αποτελεί σφάλμα στο μέλλον.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Η εφαρμογή δεν είναι συμβατή με την έκδοση CDE360 σας. Εάν συνεχίσετε μπορείτε να εγκαταστήσετε την εφαρμογή. Η εφαρμογή ίσως να μην λειτουργεί σωστά.",
    ...
    "Nextcloud Talk for iOS" : "CDE360 Talk για iOS",
    "Nextcloud Talk for Android" : "CDE360 Talk για Android",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Ελέγξτε την ασφάλεια του CDE360 σας μέσω <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">της σάρωσης ασφαλείας μας ↗</a>.",
    "Version" : "Έκδοση",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Αναπτύχθηκε από τη {communityopen}CDE360 κοινότητα{linkclose}, τον πηγαίο κώδικα {githubopen} {linkclose} αδειοδοτημένο υπό το {licenseopen}AGPL{linkclose}.",
