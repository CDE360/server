OC.L10N.register(
    ...
    "Verifying" : "Перевірка",
    "Nextcloud settings" : "Налаштування CDE360",
    "Enforce two-factor authentication" : "Примусова двофакторна аутентифікація",
    "Limit to groups" : "Обмежити групами",
    "Save changes" : "Зберегти зміни",
    "This app is supported via your current Nextcloud subscription." : "Підтримка застосунку через вашу поточну передплату CDE360.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Відсутня інформація щодо підтримки цього застосунку вашою версією CDE360. Ви зможете встановити цей застосунок, проте він може працювати не так, як ви очікуєте.",
    ...
    "iPhone" : "iPhone",
    "iPad" : "iPad",
    "Nextcloud iOS app" : "Застосунок CDE360 для iOS",
    "Nextcloud Android app" : "Застосунок CDE360 для Android",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Перевірте безпеку вашого CDE360 <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">скануваннм безпеки ↗</a>.",
    "Version" : "Версія",
    ...
    "Developed by the {communityopen}Nextcloud community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Розроблено {communityopen}спільнотою CDE360{linkclose}. Ліцензія {licenseopen}AGPL{linkclose} на {githubopen}початковий код{linkclose}.",
